            ...
            <ValidatorForm ref={form} onSubmit={handleSubmit}>
                <Box style={{ display: 'block', width: '100%', marginBottom: 5 }}>
                    <Box sx={{ float: "left", minWidth: "45%", margin: 2, boxShadow, borderRadius }}>
                        <RenderFormContols shadow={true} location="discount" mode={props.mode} title={"Discount"}
                            controls={props.controls.discount} options={props.options} onInputChange={OnInputChange} />
                    </Box>
                </Box>
            </ValidatorForm>
        </Box>
